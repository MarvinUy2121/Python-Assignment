...
gross_pay= input("Gross Pay : " )
tax_rate= input("Tax Rate : ")
expenses= input("Expenses : ")
def savings(gross_pay, tax_rate, expenses):
    print(int(int(expenses) - (int(gross_pay) * float(tax_rate))))
...
job_consumption= int(input("Amount of Material per Job : "))
def material_waste(total_material, material_units, num_jobs, job_consumption):
...
height_inches = int(input("Remaining inches: "))
